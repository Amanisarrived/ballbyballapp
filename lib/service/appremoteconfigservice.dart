...
class AppRemoteConfigService {
  ...
  static Future<RatingConfig> getRatingConfig() async {
    ...
    return RatingConfig(
      ...
      body: config['rating_body'] as String? ?? 'Rate us on Play Store!',
      buttonText: config['rating_button_text'] as String? ?? 'Rate Now',
      cancelText: config['rating_cancel_text'] as String? ?? 'Later',

  ...
  Widget build(BuildContext context) {
    if (!_loaded) {
      return const Scaffold(
        backgroundColor: _bg,
        body: Center(child: SizedBox(width: 18, height: 18,
            ...
            child: ClipRRect(
              ...
              child: Image.network(
                ...
                errorBuilder: (_, _, _) => const Icon(
                    Icons.emoji_events_rounded, color: _accent, size: 18),
              ),
            ),
          ),
...
class _TournamentList extends StatelessWidget {
  ...
  const _TournamentList({super.key, required this.tournament, required this.category});
...
class _PlayerList extends StatelessWidget {
  ...
  final RankCategory category;
  const _PlayerList({required this.players, required this.cacheKey, required this.category});
...
class _PodiumTile extends StatelessWidget {
  ...
  Color get _medalDim {
    switch (player.rank) {
      case 1:  return _goldD;
      case 2:  return _silverD;
      case 3:  return _bronzeD;
      default: return _ts;
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      padding: EdgeInsets.symmetric(horizontal: 16, vertical: _isFirst ? 14 : 12),
      decoration: BoxDecoration(
        color: _surface,
      ...
      child: Row(children: [
        ...
        Container(
          ...
          child: ClipOval(
            child: player.flagUrl.isNotEmpty
                ? Image.network(player.flagUrl, fit: BoxFit.cover,
        ...
        Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
          ...
          Text(
            _isBat ? 'runs' : 'wkts',
            style: TextStyle(color: _medalDim, fontSize: 9, fontWeight: FontWeight.w500),
          ),
        ]),
      ]),
    );
...
class _RegularTile extends StatelessWidget {
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        Container(
          width: 34, height: 34,
          decoration: BoxDecoration(
              shape: BoxShape.circle, color: _surf3,
              border: Border.all(color: _bdr2, width: 0.5)),
          child: ClipOval(
            child: player.flagUrl.isNotEmpty
                ? Image.network(player.flagUrl, fit: BoxFit.cover,
        ...
        Expanded(
          child: Text(player.name,
              overflow: TextOverflow.ellipsis,
              style: const TextStyle(color: _tm, fontSize: 13,
        ...
        Row(children: [
          Text(
            ...
            style: const TextStyle(color: _tp, fontSize: 13,
                ...
                fontFeatures: [FontFeature.tabularFigures()], letterSpacing: -0.3),
          ),
  ...
  Widget _fallback(String name) => Container(
    ...
    child: Center(child: Text(
      name.isNotEmpty ? name[0].toUpperCase() : '?',
      style: const TextStyle(color: _ts, fontSize: 11, fontWeight: FontWeight.w600),
    )),
  );
}
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Text(label, style: const TextStyle(color: _tm, fontSize: 13,
            fontWeight: FontWeight.w500)),
      ]),
    );
  }
